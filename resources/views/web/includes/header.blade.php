        ...
        <div class="container d-flex align-items-center justify-content-between gap-5">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('home') ? 'active' : '' }}" aria-current="page" href="{{url('home#About')}}">عن المعلم</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('freelessons') ? 'active' : '' }}" aria-current="page" href="{{url('freelessons')}}">الفيديوهات المجانية</a>
                    </li>
                    <li class="nav-item">
