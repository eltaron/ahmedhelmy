...
<body style="height: 97vh">
    <div class="container">
      <div class="main">
        ...
        /></a>
        <p> تم انشاء الحساب بنجاح في انتظار التفعيل بعد  التواصل واتساب علي رقم <b style="color: #fff">0096551665262</b></p>
        <h3>يمكنك استخدام الكود التالي <b style="color: #fff">{{$code}}</b> لتسجيل الدخول مرة اخري</h3>
       <div class="button">
