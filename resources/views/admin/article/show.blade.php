            ...
            <div class="card-body">
                ...
                <div class="d-flex">
                    <div class="d-flex align-items-center text-muted font-weight-light">
                        {!! $article->allow_comment == 1 ? '<span class="badge badge-success">التعليقات مفعلة</span>' : '<span class="badge badge-danger">التعليقات غير مفعلة</span>'!!}
                    </div>
                </div>
...
<div class="row">
    <div class="col-12 grid-margin ">
        <div class="card ">
            <div class="card-body ">
                <h3 class="card-title mb-3">جميع صور المقال</h3>
                <div class="row">
                        ...
                        <div class="col-md-4 p-2">
                            <div class="card bg-dark text-white">
                                ...
                                <div class="card-img-overlay text-center">
                                    <button type="button " class="mt-5 btn btn-danger btn-lg delete_post" data-id="{{$item->id}}" data-article_id="{{$article->id}}">حذف</button>
                                </div>
                            </div>
                        </div>
                    @endforeach
...
<div class="row">
    <div class="col-12 grid-margin ">
        <div class="card ">
            <div class="card-body ">
                <h3 class="card-title mb-3">جميع تعليقات المقال</h3>
                <div class="row">
...
<div class="modal fade" id="remove" tabindex="-1" aria-labelledby="removeLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{aurl('articles/deleteImage')}}" method="POST">
                @csrf
